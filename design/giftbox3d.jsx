// giftbox3d.jsx — 養生六味禮盒 · the 3D auspicious gift box.
...
// thing animates like a flat 2D illustration. Needs: jars.jsx (Jar), data.jsx (TONES).
...
// Added cy = 0 to the destructured parameters and factored it into the base Y calculation.

function gb3JarStyle({ cx, cy = 0, cz, s, i }) {
...
function GiftBox3D({ caption = true, slots, fill }) {
...
onClick={() => gb3Replay(ref.current && ref.current.querySelector(".gb3"))}
...
Object.assign(window, { GiftBox3D, WellnessGiftBox, gb3Replay, GB3_LAYOUT });